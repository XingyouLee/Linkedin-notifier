...
def _extract_output_text(response_json):
    return llm_runtime.extract_output_text(response_json)
...
def _load_resume_text(
    *,
    ...
    return load_resume_text(resume_path=resume_path, resume_text=resume_text)
...
def _request_llm_json(
    *,
    ...
    return llm_runtime.request_llm_json(
...
def _parse_llm_endpoints_from_env() -> list[dict[str, str]]:
    return llm_runtime.parse_llm_endpoints_from_env()
...
def linkedin_fitting_notifier():
    ...
    def notify_discord(jobs_to_notify):
        ...
        for job in jobs_to_notify:
            ...
            materials_url = materials_links.issue_materials_link(
            ...
            message = (
                ...
                f"URL: {job_url}\n"
                f"Generate Materials: {materials_url}"
            )
