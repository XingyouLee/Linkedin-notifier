...
This branch (`feature/ats-resume-quality-exec`) is deprecated and should not be used as the base for new materials-generation work.

- Reason: the recent ATS-oriented materials-generation exploration on this line has been abandoned.
