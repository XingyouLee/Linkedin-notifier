...
export function ResumeUploadDialog({
  ...
  const resolvedAcceptedFileTypes = acceptedFileTypes ?? DEFAULT_ACCEPTED_FILE_TYPES;
  const UPLOAD_URL = uploadUrl ?? getUploadUrl();
  ...
  const [
    ...
    accept: resolvedAcceptedFileTypes.join(','),
    multiple: false,
