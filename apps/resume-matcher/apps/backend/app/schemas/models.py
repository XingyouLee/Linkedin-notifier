...
class LaunchJobContext(BaseModel):
    """Canonical + workspace job context for integration launch."""
...
class LaunchResumeContext(BaseModel):
    """Selected resume context for integration launch."""
...
class LaunchProfileContext(BaseModel):
    """Profile context for integration launch."""
...
class IntegrationLaunchData(BaseModel):
    """Payload for launch initialization."""
...
class IntegrationLaunchResponse(BaseModel):
    """Response for integration launch initialization."""

    data: IntegrationLaunchData


class IntegrationGenerateRequest(BaseModel):
    """Generate tailored materials from the launch flow."""
...
class IntegrationGenerateData(BaseModel):
    """Result of launch flow generation."""
...
class IntegrationGenerateResponse(BaseModel):
    """Response for launch flow generation."""
